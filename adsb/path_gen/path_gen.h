...
//Variables used to add noise to generated values for messages.
float noise_alt=0.05;                  //Random noise offset for altitude.
float noise_lat=0.0;
float noise_lon=0.0;
float noise_vel=0.05;                  //Random noise offset for velocity.
float noise_dir=0.05;                  //Random noise offset for direction.
float noise_vr =0.05;
